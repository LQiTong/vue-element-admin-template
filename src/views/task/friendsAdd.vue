  ...
  <div class="main-page-content">
    ...
    >
      <div slot="ape-drawer" class="drawer-container">
        <el-form ref="form" :model="form" :rules="rules" label-width="150px" :inline="false">
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: '号段', name: 'name' },
        { title: '总采集数', name: 'name' },
        { title: '号段类型', name: 'name' },
        { title: '采集有效账号', name: 'name' },
        { title: '指定性别', name: 'name' },
        { title: '过滤最近上线时间', name: 'name' },
        { title: '话术', name: 'name' },
        { title: '添加好友数', name: 'name' },
        { title: '已添加成功数', name: 'name' },
        { title: '自动应答成功数', name: 'name' },
